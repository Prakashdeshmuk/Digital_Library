...
export const filePath = new Map<string, string>([
  [
    "HTML and CSS: Design and Build Websites",
    "/HTML and CSS: Design and Build Websites.pdf",
  ],
  ["Computer Science Distilled", "/Computer Science Distilled.pdf"],
  ["System Design Interview", "/System Design Interview.pdf"],
  ["The Art of Assembly Language", "/The Art of Assembly Language.pdf"],
  ["Seriously Good Software", "/Seriously Good Software.pdf"],
  ["Fundamentals of Database Systems", "/Fundamentals of Database Systems.pdf"],
  ["The Clean Coder", "/The Clean Coder.pdf"],
  ["The Lean Startup", "/The Lean Startup.pdf"],
  ["Algorithms", "/Algorithms.pdf"],
  ["Cracking the Coding Interview", "/Cracking the Coding Interview.pdf"],
  ["React in Action", "/React in Action.pdf"],
  ["CSS in Depth", "/CSS in Depth.pdf"],
  ["Atomic Habits", "/Atomic Habits.pdf"],
  [
    "Fullstack React: The Complete Guide to ReactJS",
    "/Fullstack React: The Complete Guide to ReactJS.pdf",
  ],
  ["Operating System Concepts", "/Operating System Concepts.pdf"],
